	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnSearch.setOnClickListener(new OnClickListener() {			
			...
			public void onClick(View v) {
				...
				//输入的起点、终点不能为空
				if( TextUtils.isEmpty(qidian) ||
						TextUtils.isEmpty(zhongdian) ){
    				...
    				editor.commit(); 
        			my_adapter = new RouteAdapter(
        					SearchActivity.this,R.layout.route_item,routeList);
	...
	private void getYuE(String account2){
		...
		new Thread( new Runnable() {	//开启子线程		
			...
			public void run() {
				...
				//  打开链接
					URL url = new URL(
							"http://"+iip.getMy_ip()+":8080/pc/getYuE.jsp?account=" + account2);
