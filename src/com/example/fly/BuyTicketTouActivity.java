...
public class BuyTicketTouActivity extends Activity {
	...
	static int chajia;
	long startTime = 0;
	private TextView title_txt, date_txt, go_txt, get_txt, fly_time_txt, depart_airport_txt, land_airport_txt,
			account_txt, serve_txt, total_price_txt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		total_price_txt = (TextView) findViewById(R.id.total_price_txt); // 设置票价
																			// piaojiao仍为整数
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (zonge - chajia == 30)
					baoxian = "您已购买意外险";
				else if (zonge - chajia == 20)
					baoxian = "您已购买延误险";
				else if (zonge - chajia == 50)
					baoxian = "您已购买延误险、意外险";
				else
					baoxian = "您没有购买保险";
				...
				// 乘客等信息不能为空！！！
				if (TextUtils.isEmpty(passenger) || TextUtils.isEmpty(birthday) || TextUtils.isEmpty(nation)
